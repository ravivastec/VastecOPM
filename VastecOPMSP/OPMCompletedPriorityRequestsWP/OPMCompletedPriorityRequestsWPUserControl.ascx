...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMCompletedPriorityRequestsWPUserControl.ascx.cs" Inherits="VastecOPMSP.OPMCompletedPriorityRequestsWP.OPMCompletedPriorityRequestsWPUserControl" %>
...
<script src="/_layouts/15/VastecOPMSP/CompletedPriorityRequests.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
...
<div id="manifestParentDiv" style="display: none">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3>Completed Priority Requests</h3>
        </div>
    ...
    <%--<h3>Completed Priority Requests <span tabindex="0" class="wf wf-size-x18 wf-family-o365 wf-o365-question" role="presentation" style="font-size: 22px; vertical-align: middle; display: inline-block; cursor:pointer;" id="helpText" data-toggle="popover" data-trigger="focus"></span></h3>--%>
    <br />

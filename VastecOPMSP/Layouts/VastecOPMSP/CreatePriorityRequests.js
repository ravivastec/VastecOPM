$().ready(function () {
    ...
    function LoadEmployeeData() {
        ...
        CommonModule.retrieveHelpText('Create Priority Requests');
    }
});
...
var ManifestsModule = (function () {
    ...
    var initializeClickEvents = function () {
        $('#savePriorityRequest').on('click', function () {
            var manifestItemId = $("#manifestItemId").val();
            updatePriority(manifestItemId, true);

            $("#savePriorityRequest").prop("disabled", true);
        });
        ...
        $("#manifestElementsTable").on("click", ".request-priority", function () {
            ...
            var confirmMessage = "Mark " + ssn + " as a Priority Request?"
            ...
            $("#markSsnAsPriority").html(confirmMessage);
            $("#savePriorityRequest").prop("disabled", false);
            ...
            if (guidLookup != '') {
                ...
                $('#manifestElementsTable').DataTable({
                    ...
                    columns: [
                        ...
                        { title: "Request Priority", className: "text-center-align" }
            ...
            function (sender, args) {
                ...
                while (manifestElementsListItemEnumerator.moveNext()) {
                    ...
                    var manifestElement = {
                        ...
                        requestPriority: requestPriorityHtml,

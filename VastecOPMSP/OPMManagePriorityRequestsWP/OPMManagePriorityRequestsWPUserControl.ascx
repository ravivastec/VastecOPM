...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMManagePriorityRequestsWPUserControl.ascx.cs" Inherits="VastecOPMSP.OPMManagePriorityRequestsWP.OPMManagePriorityRequestsWPUserControl" %>
...
<script src="/_layouts/15/VastecOPMSP/ManagePriorityRequests.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
...
<div id="manifestParentDiv" style="display: none">
    ...
    <br />
     <div class="row">
        <div class="col-md-6">
            <h3>Manage Priority Requests</h3>
        </div>
    ...
    <%--<h3>Manage Priority Requests <span class="wf wf-size-x18 wf-family-o365 wf-o365-question" role="presentation" style="font-size: 22px; vertical-align: middle; display: inline-block; cursor:pointer;" id="helpText" data-toggle="popover" data-trigger="focus"></span></h3>--%>
    <br />
    ...
    <div id="cancelPriority" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" id="popupTitle1">Cancel Priority</h4>
                </div>
                <div class="modal-body">
                    <table id="manifestItemDetailsInPopup">
                        <tr>
                            <td class="popup-table-cell">
                                Are you sure you want to Cancel Priority?
                            </td>
                            <td class="popup-table-cell">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-info" id="cancelPriorityRequest">Yes</button>
                    <button type="button" class="btn btn-default btn-info" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>

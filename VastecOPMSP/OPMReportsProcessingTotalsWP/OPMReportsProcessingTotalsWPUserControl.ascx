...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMReportsProcessingTotalsWPUserControl.ascx.cs" Inherits="VastecOPMSP.OPMReportsProcessingTotalsWP.OPMReportsProcessingTotalsWPUserControl" %>
...
<script src="/_layouts/15/VastecOPMSP/ReportProcessingTotals.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>

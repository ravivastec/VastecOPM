...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMViewIssueFoldersWP.ascx.cs" Inherits="VastecOPMSP.OPMViewIssueFoldersWP.OPMViewIssueFoldersWP" %>
...
<script src="/_layouts/15/VastecOPMSP/ViewIssueFolders.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
...
<div id="manifestParentDiv" style="display: none">
    ...
    <%--<h3> View Issue Folders <span class="wf wf-size-x18 wf-family-o365 wf-o365-question" role="presentation" style="font-size: 22px; vertical-align: middle; display: inline-block; cursor:pointer;" id="helpText" data-toggle="popover" data-trigger="focus"></span></h3>--%>
    <br />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-info" id="saveIssueDescription">Save</button>

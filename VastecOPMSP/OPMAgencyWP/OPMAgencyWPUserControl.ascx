...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMAgencyWPUserControl.ascx.cs" Inherits="VastecOPMSP.OPMAgencyWP.OPMAgencyWPUserControl" %>
...
<script src="/_layouts/15/VastecOPMSP/CreateManifests.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
...
<div id="manifestParentDiv" style="display: none">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div id="manifestIntroductionText" style="padding-left: 25px;">
            </div>
        </div>
        <div class="col-md-5 global-search-wrapper">
            Search:
    ...
    <%-- <div class="create-new-manifest-wrapper">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createNewManifest" id="createNewManifestButton">Create New Manifest</button>
        <span id="manifestText" style="padding-left: 50px;">Hello Test manifest description</span>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="popup-table-cell">
                                <select id="newConversionType">
                                    ...
                                    <option value="Day Forward">Day Forward Folder</option>
                                    <option value="Day Forward Loose Paper">Day Forward Loose Paper</option>
                                    <option value="Entrance on Duty (EOD)">Entrance on Duty (EOD)</option>
                                    <option value="ePerformance">ePerformance</option>                                   
                                </select>
                            </td>
                            <%--<td class="popup-table-cell">

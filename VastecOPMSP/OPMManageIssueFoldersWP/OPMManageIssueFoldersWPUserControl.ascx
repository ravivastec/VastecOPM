...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPMManageIssueFoldersWPUserControl.ascx.cs" Inherits="VastecOPMSP.OPMManageIssueFoldersWP.OPMManageIssueFoldersWPUserControl" %>
...
<script src="/_layouts/15/VastecOPMSP/ManageIssueFolders.js?ver=<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
...
<div id="manifestParentDiv" style="display: none">
    ...
    <%--<h3>Manage Issue Folders <span tabindex="0" class="wf wf-size-x18 wf-family-o365 wf-o365-question" role="presentation" style="font-size: 22px; vertical-align: middle; display: inline-block; cursor:pointer;" id="helpText" data-toggle="popover" data-trigger="focus"></span></h3>--%>
    <br />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="popupTitle">Resolve Issue</h4>
                </div>
                <div class="modal-body">
                    <table id="manifestItemDetailsInPopup">
                        <tr>
                            <td class="popup-table-cell">Resolve Issue Description:
                                <br />
                                (Please provide additional information how it is resolved.) </td>
                        </tr>
                        <tr>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-info" id="saveIssueDescription">Resolve Issue</button>
    ...
    <div id="updateIssueDescription" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" id="updatePopupTitle">Update Issue</h4>
                </div>
                <div class="modal-body">
                    <table id="manifestItemDetailsInUpdatePopup">
                        <tr>
                            <td class="popup-table-cell">Update Issue Description: </td>
                        </tr>
                        <tr>
                            <td class="popup-table-cell">
                                <textarea id="updateIssueDescriptionText" style="width: 100%" rows="10"></textarea>
                            </td>
                            <td class="popup-table-cell">
                                <div id="updateIssueDescriptionTextPrev" style="display: none"></div>
                                <input type="text" id="updateManifestItemId" style="display: none" />
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-info" id="saveUpdateIssueDescription">Update Issue</button>
                    <button type="button" class="btn btn-default btn-info" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
